...
public class BookingDAO {
    ...
    public void insertBookingDetail(int bookingID, int roomTypeId, int quantity,
                                    double pricePerNight, int guests) throws SQLException {
        String sql = "INSERT INTO bookingdetails (BookingID, RoomTypeID, Quantity, PricePerNight, GuestsCount) VALUES (?, ?, ?, ?, ?)";
