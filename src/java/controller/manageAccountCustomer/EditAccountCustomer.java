...
import controller.managerAccountStaff.EditAccount;
 ...
 * @author MyPC
 */
@WebServlet(name="EditAccountCustomer", urlPatterns={"/editAccountC"})
public class EditAccountCustomer extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditAccountCustomer</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditAccountCustomer at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (hasError) {
            request.getRequestDispatcher("managerAccountC").forward(request, response);
            return;
        }

        // Cập nhật vào CSDL
        AccountDAO ad = new AccountDAO();
        ad.editAccountC(user, pass, isActive, email, aid);
