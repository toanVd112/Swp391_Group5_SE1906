                                ...
                                <div class="room-card" data-room-type-id="${room.roomTypeId}">
                                    ...
                                    <div class="guest-selection-row">
                                        ...
                                        <div class="guest-selection">
                                            <h4><i class="fas fa-user-friends"></i> Chọn số lượng khách</h4>
                                        ...
                                        <!-- Khối chọn số lượng phòng -->
                                        <div class="guest-selection">
                                            <h4><i class="fas fa-layer-group"></i> Chọn số lượng phòng</h4>
                                            <div class="guest-controls">
                                                <div class="guest-control">
                                                    <label>Số lượng</label>
                                                    <div class="counter-group">
                                                        <button type="button" class="counter-btn" onclick="updateRoomQuantityUI('${room.roomTypeId}', -1)">
                                                            <i class="fas fa-minus"></i>
                                                        </button>
                                                        <span class="counter-value" id="quantity_${room.roomTypeId}">1</span>
                                                        <button type="button" class="counter-btn" onclick="updateRoomQuantityUI('${room.roomTypeId}', 1)">
                                                            <i class="fas fa-plus"></i>
                                                        </button>
                                                    </div>
