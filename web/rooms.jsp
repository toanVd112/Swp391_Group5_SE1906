    ...
    <head>
        ...
        <script>
            function toggleSection(id, btn) {
                ...
                if (section.classList.contains("opening") || section.classList.contains("closing"))
                    return;
                ...
                if (section.style.maxHeight && section.style.maxHeight !== "0px") {
                    ...
                    // Thêm vào danh sách m? n?u ch?a có
            ...
            // T? ??ng m? l?i nhi?u ph?n ?ã l?u sau reload
                        ...
                        <div class="container clearfix">
                            ...
                            <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                                ...
                                <ul class="nav navbar-nav">	
                                    ...
                                    </li> <li><a href="myrooms"><i class="fa fa-bed"></i> My Booking</a></li>
                                </ul>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                                    ...
                                    <div class="widget widget_archive">
                                        ...
                                        <div id="sortSection" class="collapsible">
                                            <c:set var="sortOptions" value="asc,desc,floor-asc,floor-desc" />
                                            <ul>
                                                <c:forEach var="option" items="${fn:split(sortOptions, ',')}">
                                                    ...
                                                    <li class="${sort == option ? 'active' : ''}">
                                                        <a href="${urlSort}">
                                                            <c:choose>
                                                                <c:when test="${option == 'asc'}">Giá t?ng d?n</c:when>
                                                                <c:when test="${option == 'desc'}">Giá gi?m d?n</c:when>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-sm-6 m-b30">
                                                <div class="cours-bx">
                                                    ...
                                                    <div class="info-bx text-center">
                                                        ...
                                                        <h5>Floor ${r.floor}</h5>
                                                        <span>${r.roomType.name}</span> <!-- Tên lo?i phòng -->
                                                    </div>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${sessionScope.user == null}">
                                                            <!-- Ch?a ??ng nh?p: thêm vào localStorage -->
                                                        ...
                                                        <c:otherwise>
                                                            <!-- ?ã login: g?i b?ng fetch ??n servlet -->
