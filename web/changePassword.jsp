<%-- 
    ...
    Created on : Jul 9, 2025, 4:16:01 PM
    Author     : AD
--%>
...
<html lang = "vi">
    ...
    <!-- PAGE TITLE HERE ============================================= -->
    <title>HoangNam Hotel - Change Password</title>
    ...
    <!-- All PLUGINS CSS ============================================= -->
    <link href="Customer/profile.css" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="assets/css/assets.css">
    
    <style>
        .error-message { color: #d32f2f; margin-bottom: 10px; }
...
<body>
    <div class="profile-container">
        <div class="profile-header">
            ...
            <p class="page-description">Update your account password to keep your profile secure</p>
        </div>
