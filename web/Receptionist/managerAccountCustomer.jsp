    ...
    <body class="bg-light">
        <div class="container py-4">
            <div class="card shadow-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <form action="loadAccountC" method="post" style="display:inline;">
                                                    <input type="hidden" name="aid" value="${account.accountID}"/>
                                                    <button type="submit" class="btn btn-sm btn-outline-primary" title="Chỉnh sửa">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                </form>
                                                <a href="deleteAccountC?aid=${account.accountID}" class="btn btn-sm btn-outline-danger" 
                ...
                <div class="card-footer bg-white">
                    <a href="Receptionist/reception.jsp" class="btn btn-primary">
        ...
        <div class="modal fade" id="addAccountModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <form action="addAccountC" method="post" id="accountForm" class="modal-content" novalidate>
