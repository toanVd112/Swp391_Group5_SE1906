                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <a href="loadAccountC?aid=${account.accountID}"
                                                       class="btn btn-primary btn-sm">Edit</a>
                                                    <c:choose>
                                                        <c:when test="${account.isActive}">
                                                            <a href="deleteAccountC?aid=${account.accountID}&action=deactivate"
                                                        ...
                                                        <c:otherwise>
                                                            <a href="deleteAccountC?aid=${account.accountID}&action=activate"
                            ...
                            <nav class="mt-4">
                                <ul class="pagination justify-content-center">
                                    <c:if test="${currentPage > 1}">
                                        <li class="page-item">
                                            <a class="page-link"
                                               href="managerAccountC?page=${currentPage - 1}&search=${fn:escapeXml(param.search)}&sort=${fn:escapeXml(param.sort)}">
                                    ...
                                    <c:forEach begin="1" end="${totalPages}" var="i">
                                        <li class="page-item ${i == currentPage ? 'active' : ''}">
                                            <a class="page-link"
                                               href="managerAccountC?page=${i}&search=${fn:escapeXml(param.search)}&sort=${fn:escapeXml(param.sort)}">${i}</a>
                                        </li>
                                    </c:forEach>
