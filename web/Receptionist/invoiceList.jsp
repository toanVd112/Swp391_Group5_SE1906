        ...
        <div class="container py-4">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body"> 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <strong><%= invoice.getCustomerName() != null ? invoice.getCustomerName() : "N/A" %></strong>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="currency-amount text-info">
                                            <%= String.format("%,.0f", invoice.getServiceTotal()) %> đ
                                        </span>
                                    </td>
                                    <td class="text-nowrap">
                                ...
                                <tr>
                                    <td colspan="9" class="text-center py-4">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <h5 class="text-muted">No matching invoices found</h5>
                                            <p class="text-muted mb-0">Try changing the search filters to see more results</p>
                                        </div>
                                    </td>
                                </tr>
                                <%
                    ...
                    <!-- Summary Statistics - Fixed null handling -->
                    <%
                        // Calculate statistics safely without using Stream API
                        if (invoiceList != null && !invoiceList.isEmpty()) {
                                    ...
                                    <div class="row text-center"> 
                                        <div class="col-md-3"> 
                                            <div class="border-end"> 
                                                <h5 class="text-primary mb-0"><%= totalInvoices %></h5> 
                                        ...
                                        <div class="col-md-3"> 
                                            <div class="border-end"> 
                                                <h5 class="text-warning mb-0"><%= unpaidCount %></h5> 
