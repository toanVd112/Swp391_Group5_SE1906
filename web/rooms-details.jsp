                                                    ...
                                                    <h5 class="availability" style="font-size: 20px; font-weight: bold;">
                                                        <c:choose>
                                                            <c:when test="${availableRooms != null and availableRooms > 0}">
                                                                <span class="text-success">${availableRooms} phòng còn tr?ng</span>
                                                            </c:when>
                                                            <c:when test="${availableRooms == 0 or empty availableRooms}">
                                                                <span class="text-danger">H?t phòng</span>
                                                            </c:when>
                                                        </c:choose>
                                                    </h5>
                                            </div>
                                    ...
                                    <div class="courese-overview" id="overview">
                                        ...
                                        <div class="row">
                                                ...
                                                <ul class="course-features">
                                                    <c:choose>
                                                        <c:when test="${not empty amenities}">
                                                            ...
                                                            <c:otherwise>
                                                            <li class="no-data">Không có ti?n ích nào ?? hi?n th?.</li>
                                                            </c:otherwise>
                                                        </c:choose>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-lg-8">
                                                ...
                                                <ul>
                                                    <li>Tr? phòng: Tr??c 12:00</li>
                                                    <li>Có th? nh?n/tr? phòng s?m ho?c mu?n, tùy tình hình th?c t? và có th? thu phí.</li>
                                                    <li>Tu?i t?i thi?u ?? nh?n phòng: 18 tu?i.</li>
                                                    <li>Không cho phép mang v?t nuôi (tr? v?t nuôi h? tr? ng??i khuy?t t?t).</li>
                                                    <li>Khách ch?a k?t hôn có th? không ???c l?u trú chung phòng theo quy ??nh ??a ph??ng.</li>
                                                    <li>Không ???c mang ?? ?n/th?c u?ng bên ngoài vào khuôn viên khách s?n.</li>                                                
                                                </ul>

                                                <h5 class="m-b5">Thông tin quan tr?ng</h5>
                                                <ul>
                                                    <li>Có d?ch v? ??a ?ón sân bay, c?n ??t tr??c ít nh?t 48 gi? (phí: 270,000 VND/ng??i/l??t).</li>
                                                    <li>Ph? phí b?a sáng buffet: 345,000 VND (ng??i l?n), 172,500 VND (tr? em).</li>
                                                    <li>Phí gi??ng ph?: 900,000 VND/?êm.</li>
                                                    <li>C?n mang theo gi?y t? tùy thân và ??t c?c b?ng ti?n m?t/th? khi nh?n phòng.</li>
                                                    <li>Khách s?n có không gian ngoài tr?i (ban công, sân th??ng) ? không phù h?p v?i tr? nh? n?u không giám sát.</li>
                                                    <li>Khách d??i 18 tu?i ???c s? d?ng spa d??i s? giám sát c?a ng??i l?n.</li>
                                                    <li>Ch?p nh?n thanh toán b?ng ti?n m?t, th? ghi n? và th? tín d?ng.</li>
                                                </ul>

                                                <h5 class="m-b5">Câu h?i th??ng g?p (FAQ)</h5>
                                                <ul class="list-checked primary">
                                                    <li><strong>Khách s?n Hoàng Nam có h? b?i không?</strong><br/>Có, khách s?n có h? b?i ph?c v? khách l?u trú.</li>
                                                    <li><strong>Khách s?n có cho phép mang theo v?t nuôi không?</strong><br/>Không, khách s?n không cho phép v?t nuôi.</li>
                                                    <li><strong>Phí ??u xe là bao nhiêu?</strong><br/>Vui lòng liên h? tr?c ti?p ?? bi?t chi ti?t.</li>
                                                    <li><strong>Gi? nh?n phòng t?i khách s?n Hoàng Nam?</strong><br/>T? 15:00 m?i ngày.</li>
                                                    <li><strong>Gi? tr? phòng?</strong><br/>Tr??c 12:00 tr?a.</li>
                                                    <li><strong>Khách s?n có d?ch v? ??a ?ón sân bay không?</strong><br/>Có, v?i ph? phí và c?n ??t tr??c ít nh?t 48 gi?.</li>
                                                    <li><strong>Khách s?n Hoàng Nam t?a l?c ? ?âu?</strong><br/>Khách s?n n?m t?i trung tâm thành ph?, g?n bi?n và các ?i?m tham quan n?i b?t.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="image-gallery-row">
                                                ...
                                                <c:choose>
                                                    <c:when test="${not empty images and not empty images[0].imageUrl}">
                                                        <img src="${fn:escapeXml(images[0].imageUrl)}"
                                                             alt="?nh chính c?a ${fn:escapeXml(roomType.name)}"
                                                             onclick="openGallery('all')"
                                                             loading="lazy"
                                                             onerror="this.style.display='none'" />
                                                    </c:when>
                                                    <c:otherwise>
                                                        <p class="no-data">Không có ?nh chính ?? hi?n th?.</p>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                                            <div class="thumb-2x2-box">
                                                <c:choose>
                                                    <c:when test="${not empty images and fn:length(images) > 1}">
                                                        <c:forEach var="img" items="${images}" begin="1" end="4">
                                                            <img src="${fn:escapeXml(img.imageUrl)}"
                                                                 alt="${not empty img.categoriesAsString ? fn:escapeXml(img.categoriesAsString) : '?nh phòng'}"
                                                    ...
                                                    <c:otherwise>
                                                        <p class="no-data">Không có ?nh ph? ?? hi?n th?.</p>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="category-tabs">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <p class="no-data">Không có danh m?c nào ?? hi?n th?.</p>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                                                            ...
                                                            <c:forEach var="img" items="${images}">
                                                                <div class="gallery-item" 
                                                                    ...
                                                                    <img src="${fn:escapeXml(img.imageUrl)}" 
                                                                         ...
                                                                         loading="lazy"
                                                                         onerror="this.style.display='none'" />
                                                                    <p class="image-caption">${not empty img.categoriesAsString ? fn:escapeXml(img.categoriesAsString) : 'Không xác ??nh'}</p>
                                                                </div>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <p class="no-data">Không có ?nh nào ?? hi?n th?.</p>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </div>
                                            </div>
