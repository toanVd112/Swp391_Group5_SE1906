                        ...
                        <div class="container">
                            <div class="row">
                                            ...
                                            <div class="acod-head">
                                                <h6 class="acod-title"> 
                                                    <a data-toggle="collapse"  href="#faq4" class="collapsed"  data-parent="#faq4">
                                                        Why aren't My Booking showing in my account? </a> </h6>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <form class="contact-bx" action="submitQuestion" method="post">
                                        <div class="heading-bx left">
                                            <h2 class="title-head">Submit <span>Your Question</span></h2>
                                            <p>Please fill in the form below to send us your question. We will respond soon.</p>
                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="question" rows="4" class="form-control" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
