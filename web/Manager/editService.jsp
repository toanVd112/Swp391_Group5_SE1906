        ...
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/editService" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="${service.name}" required> <%-- Hiển thị tên hiện tại, bắt buộc nhập --%>
                </div>
                
                <%-- Nhóm input: Mô tả --%>
                <div class="form-group">
                    <label for="description">Mô tả:</label>
                    <textarea id="description" name="description" rows="4">${service.description}</textarea> <%-- Hiển thị mô tả hiện tại, không bắt buộc --%>
                </div>
                
                <%-- Nhóm input: Giá --%>
                <div class="form-group">
                    <label for="price">Giá:</label>
                    <%-- Định dạng giá không có dấu phẩy để phù hợp với input number --%>
                ...
                <div class="form-group">
                    ...
                    <select id="status" name="status">
                        <%-- Hiển thị trạng thái hiện tại (1 = Hoạt động, 0 = Ngừng Hoạt động) --%>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="serviceImage" name="serviceImage" value="${service.serviceImage}"> <%-- Hiển thị URL hình ảnh hiện tại, không bắt buộc --%>
                </div>
